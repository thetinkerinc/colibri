...
<div>
    ...
    {#if !outputWidth}
        <div class="flex items-center justify-center gap-4 mt-4">
            <div>Size:</div>
            <Checkbox value="small" bind:group={size}>
                Small
            </Checkbox>
            <Checkbox value="medium" bind:group={size}>
                Medium
            </Checkbox>
            <Checkbox value="large" bind:group={size}>
                Large
            </Checkbox>
            <Checkbox value={false} bind:group={size}>
                Original
            </Checkbox>
        </div>
    {/if}
    <div class="flex items-center justify-center gap-4 mt-4">
        {#if rotationControls}
            <i class="fas fa-undo text-lg cursor-pointer"
        ...
        {#if rotationControls}
            <i class="fas fa-redo text-lg cursor-pointer"
