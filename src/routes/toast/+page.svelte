...
<Page title="Toast" canStyle={true} {template}>
	<svelte:fragment slot="description">
		...
		component, and the
		<span class="code text-black">toaster</span>
		...
		<span class="code text-black">info</span>
		,
		<span class="code text-black">success</span>
		,
		<span class="code text-black">warning</span>
		, and
		<span class="code text-black">error</span>
